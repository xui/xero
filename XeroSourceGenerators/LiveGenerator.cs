    ...
    namespace SourceGenerators
    {
        ...
        public class LiveGenerator : ISourceGenerator
        {
            ...
            public void Execute(GeneratorExecutionContext context)
            {
                ...
                INamedTypeSymbol attributeSymbol = context.Compilation.GetTypeByMetadataName("Xero.SourceGenerators.LiveAttribute");
                ...
                public void OnVisitSyntaxNode(GeneratorSyntaxContext context)
                {
                        ...
                        && fieldDeclarationSyntax.AttributeLists.Count > 0)
                    {
                        foreach (VariableDeclaratorSyntax variable in fieldDeclarationSyntax.Declaration.Variables)
                        {
                            ...
                            if (fieldSymbol.GetAttributes().Any(ad => ad.AttributeClass.ToDisplayString() == "Xero.SourceGenerators.LiveAttribute"))
                            {
